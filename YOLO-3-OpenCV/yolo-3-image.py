...
"""
# Carregar labels do COCO
with open('yolo-coco-data/coco.names') as f:
    labels = [line.strip() for line in f]

# # Verificação das labels carregadas
# print('List with labels names:')
# print(labels)

# Carregar a rede YOLO v3
network = cv2.dnn.readNetFromDarknet('yolo-coco-data/yolov3.cfg',
                                     'yolo-coco-data/yolov3.weights')

# Obter nomes de todas as camadas da rede YOLO v3
layers_names_all = network.getLayerNames()

# Verificação dos nomes das camadas
# print()
# print(layers_names_all)

# Obter apenas os nomes das camadas de saída necessárias
layers_names_output = [layers_names_all[i - 1] for i in network.getUnconnectedOutLayers().flatten()]

# Verificação dos nomes das camadas de saída
# print()
# print(layers_names_output)  # ['yolo_82', 'yolo_94', 'yolo_106']

# Definir a probabilidade mínima para eliminar previsões fracas
probability_minimum = 0.5

# Definir o limiar para filtrar caixas delimitadoras fracas com supressão não-máxima
threshold = 0.3

# Gerar cores para representar cada objeto detectado
colours = np.random.randint(0, 255, size=(len(labels), 3), dtype='uint8')

# Verificação das cores geradas
# print()
# print(type(colours))  # <class 'numpy.ndarray'>
# print(colours.shape)  # (80, 3)
# print(colours[0])  # Exemplo de saída: [172  10 127]
